...
def send_cutaways_report(token='', hostname='', v='2.0', start_date=None, end_date=None, offset=0, limit=0):
    end_time = datetime.datetime.now().strftime('%H:%M:%S')
    start_date = "{} 00:00:00".format(start_date)
    end_date = "{} {}".format(end_date, end_time)
    data = {
...
def send_other_report(token='', hostname='', v='2.0', start_date=None, end_date=None, offset=0, limit=0):
    end_time = datetime.datetime.now().strftime('%H:%M:%S')
    start_date = "{} 00:00:00".format(start_date)
    end_date = "{} {}".format(end_date, end_time)
    data = {
